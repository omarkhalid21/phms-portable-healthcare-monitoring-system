...
class _FirebaseWidgetState extends State<FirebaseWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FirebaseModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'firebase'});
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('FIREBASE_arrow_back_rounded_ICN_ON_TAP');
