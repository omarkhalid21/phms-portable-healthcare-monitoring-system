              ...
              children: [
                Align(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'SETTING_PAGE_Container_naawk25q_ON_TAP');
                      ...
                      _model.soundPlayer!
                          .setAsset('assets/audios/hjql6_9.mp3')
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('SETTING_PAGE_ARABIC_BTN_ON_TAP');
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('SETTING_PAGE_WHITE_MODE_BTN_ON_TAP');
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('SETTING_PAGE_SYSTEM_MODE_BTN_ON_TAP');
                      logFirebaseEvent('Button_set_dark_mode_settings');
                      setDarkModeSetting(context, ThemeMode.system);
                    },
                    text: FFLocalizations.of(context).getText(
                      'nsp6blmi' /* System mode */,
                    ),
                    options: FFButtonOptions(
                      width: 114.2,
                      height: 50.0,
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('SETTING_PAGE_DARK_MODE_BTN_ON_TAP');
                      logFirebaseEvent('Button_set_dark_mode_settings');
                ...
                Align(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'nizrvjhx' /* Set the mode of  the applicati... */,
                    ),
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Poppins',
                          fontSize: 16.0,
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('SETTING_PAGE_DELETE_USER_BTN_ON_TAP');
                      logFirebaseEvent('Button_auth');
                      await authManager.deleteUser(context);

                      context.goNamedAuth('Datapage', context.mounted);
                    },
                    text: FFLocalizations.of(context).getText(
                      'u4mny30s' /* Delete user */,
                    ),
                    options: FFButtonOptions(
                      width: 130.0,
                      height: 40.0,
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('SETTING_PAGE_ENGLISH_BTN_ON_TAP');
                      logFirebaseEvent('Button_set_app_language');
                ...
                Align(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      '7wtsay27' /* Set the language of  the appli... */,
                    ),
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Poppins',
                          fontSize: 16.0,
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('SETTING_PAGE_ABOUT_US_BTN_ON_TAP');
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('SETTING_PAGE_SUPPORT_BTN_ON_TAP');
                      logFirebaseEvent('Button_navigate_to');
